...
class RPaginatorHelper extends AppHelper
{
	...
	public function controls(&$paginator, $options = array())
	{
		...
		$out =	$this->_paginator->first('<< '.__d('r_search', 'first'), array(), null, array('class'=>'disabled')) .
				$this->_paginator->prev(__d('r_search', 'previous'), array(), null, array('class'=>'disabled')) .
				$this->_paginator->numbers(array('separator' => '')) .
				$this->_paginator->next(__d('r_search', 'next'), array(), null, array('class' => 'disabled')) .
				$this->_paginator->last(__d('r_search', 'last').' >>', array(), null, array('class' => 'disabled'));
